...
public class ObjectSrcConvertUtils {
    Function<ObjectSrc, ObjectTarget> toTarget = ObjectSrcConvertUtils::toObjectTarget;
    ...
    public static List<ObjectTargetItem> toObjectTargetItemList(ObjectSrc src) {
        ...
        if (src.items != null) {
            result = src.items.stream()
                    .map(ObjectSrcConvertUtils::toObjectTargetItem)
